var SVGtoPDF = function (doc, svg, x, y, options) {
    ...
    function parseXml(xml) {
        ...
        Object.defineProperty(SvgNode.prototype, 'children', {
            get: function () {
                if (this.nodeType === 1) {
                    let temp = [];
        ...
        Object.defineProperty(SvgNode.prototype, 'parentElement', {
            get: function () {
                return this.parentNode;
            }
        });
        Object.defineProperty(SvgNode.prototype, 'tagName', {
            get: function () {
                if (this.nodeType === 1) {
        ...
        Object.defineProperty(SvgNode.prototype, 'id', {
            get: function () {
                if (this.nodeType === 1) {
        ...
        Object.defineProperty(SvgNode.prototype, 'name', {
            get: function () {
                if (this.nodeType === 1) {
        ...
        Object.defineProperty(SvgNode.prototype, 'textContent', {
            get: function () {
    ...
    function parseColor(v) {
        let NamedColors = {
            aliceblue: [240, 248, 255], antiquewhite: [250, 235, 215], aqua: [0, 255, 255], aquamarine: [127, 255, 212], azure: [240, 255, 255], beige: [245, 245, 220], bisque: [255, 228, 196], black: [0, 0, 0], blanchedalmond: [255, 235, 205], blue: [0, 0, 255], blueviolet: [138, 43, 226], brown: [165, 42, 42], burlywood: [222, 184, 135], cadetblue: [95, 158, 160], chartreuse: [127, 255, 0],
    ...
    var SvgShape = function (commands) {
        ...
        // Shape properties
        let pathSegments = null; Object.defineProperty(this, 'pathSegments', {
            get: function () {
        ...
        let boundingBox = null; Object.defineProperty(this, 'boundingBox', {
            get: function () {
